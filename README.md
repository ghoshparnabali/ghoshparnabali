...
* Analyzed immunocytochemistry (MAP2, TRKA) and functional $Ca^{2+}$ imaging datasets for nociceptor specification and functional maturation.

### 📊 Deloitte Data Analytics Virtual Simulation (Forage)
